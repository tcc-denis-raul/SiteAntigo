<!--Script para realizar avaliação positiva de um curso do usuario-->
<?php
if ($_POST['enviardados']){
	...
	if($qtd_linhas > 0){	
		...
		echo "<script>window.location='../descricao.php';alert('Curso avaliado positivamente com sucesso');</script>";
	}
	else{
